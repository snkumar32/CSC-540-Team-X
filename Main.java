...
public class Main {
    ...
    private static final String jdbcURL = "jdbc:mariadb://classdb2.csc.ncsu.edu:3306/skumar32"; // Using SERVICE_NAME

// Update your user and password info here!

    private static final String user = "skumar32";
    private static final String password = "ncsu123";
